...
class Generator:
    ...
    def generate_welcome_page(self):
        output_file = open("helpers/data/welcome.in", 'w+')
    ...
    def generate_circular_pedestrians(self):
        output_file = open("helpers/data/circular_test.in", 'w+')
    ...
    def generate_test_1(self):
        output_file = open("helpers/data/rimea_test_1.in", 'w+')
    ...
    def generate_test_4(self, w=200, h=10, density=0.2, default=True):
        ...
        if default:
            output_file = open("helpers/data/rimea_test_4.in", 'w+')
        else:
            print(os.getcwd())
            output_file = open("helpers/data/rimea_test_4_d_" + str(density) + "_w_" + str(w) + "_h_" + str(h) + ".in", 'w+')
        ...
        if height >= 15:
            ...
            output_file.write(f"CM2({int(width / 2)},{int((height / 2) + 3)})\n")
        else:
            output_file.write(f"CM2({int(width / 2)},{int((height / 2) + 1)})\n")
    ...
    def generate_test_6(self):
        output_file = open("helpers/data/rimea_test_6.in", 'w+')
    ...
    def generate_test_7(self):
        ...
        output_file = open("helpers/data/rimea_test_7.in", 'w+')
